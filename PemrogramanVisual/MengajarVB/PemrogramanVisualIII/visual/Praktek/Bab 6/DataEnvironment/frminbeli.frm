...
Private Sub cmdTambah_Click()
 'Add a new record
    ...
    If cmdTambah.Caption = "&Tambah" Then
        DE.rsPembelian.AddNew          'kosongkan field untuk record data baru
        ...
        txtNoBon.Locked = False 'buka text kode Pembelian
          txtNamaBarang.Text = ""
    Else
        DE.rsPembelian.CancelUpdate     'Batalkan proses penambahan data
        txtNoBon.Locked = True  'kunci text kode Pembelian
        ...
        DE.rsPembelian.MoveLast         'Pindah ke record data terakhir
    End If
...
Private Sub cmdSimpan_Click()
    ...
    DE.rsBarang![Jumlah Barang] = NILAI1
    DE.rsBarang.Update
    DE.rsPembelian.Update             'simpan record
    txtNoBon.Locked = True    'kunci text kode Pembelian
    AktifkanTombol      'semua tombol penggerak record diaktifkan
